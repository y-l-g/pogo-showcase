...
ARG XCADDY_ARGS="--with github.com/dunglas/caddy-cbrotli --with github.com/dunglas/mercure/caddy --with github.com/dunglas/vulcain/caddy --with github.com/y-l-g/pogo/module@main --with github.com/y-l-g/queue/module@main --with github.com/y-l-g/scheduler/module@main --with github.com/y-l-g/websocket/module@main --with github.com/y-l-g/upload/module@master --with github.com/y-l-g/pogo-showcase/runtime/module=/go/src/app/dist/app/runtime/module"
